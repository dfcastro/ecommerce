									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<input type="radio" id="method-pagseguro" name="payment-method" placeholder="" value="1" class="input-text " style="float:left; margin:30px;" checked>
												<label class="" for="method-pagseguro"><img style="height:64px";  src="/res/site/img/logo-pagseguro.png" alt=""></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											
												<input type="radio" id="method-paypal" name="payment-method" placeholder="" value="2" class="input-text " style="float:left; margin:30px;">
												<label class="" for="method-paypal"><img style="height:64px"; src="/res/site/img/logo-paypal.png" alt=""></label>
											</p>
											<div id="payment">
